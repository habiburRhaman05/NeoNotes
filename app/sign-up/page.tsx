...
// 1. Define the SignUp Schema with Password Match validation
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-zinc-900 py-8 px-4 shadow-2xl border border-zinc-200 dark:border-zinc-800 sm:rounded-2xl sm:px-10">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <button type="button" className="flex w-full items-center justify-center gap-2 rounded-xl bg-white dark:bg-zinc-800 px-4 py-2.5 text-sm font-semibold text-zinc-900 dark:text-zinc-100 shadow-sm ring-1 ring-inset ring-zinc-300 dark:ring-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-all">
          ...
          <form className="space-y-4" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input 
                  ...
                  {...register("name")}
                  className={`block w-full px-4 py-2.5 bg-zinc-50 dark:bg-zinc-800 border ${errors.name ? 'border-red-500' : 'border-zinc-300 dark:border-zinc-700'} rounded-xl text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-indigo-600 transition-all outline-none`} 
                />
              </div>
            ...
            <div>
              ...
              <input 
                ...
                {...register("email")}
                className={`mt-1 block w-full px-4 py-2.5 bg-zinc-50 dark:bg-zinc-800 border ${errors.email ? 'border-red-500' : 'border-zinc-300 dark:border-zinc-700'} rounded-xl text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-indigo-600 transition-all outline-none`} 
              />
            ...
            <div>
              ...
              <input 
                ...
                placeholder="••••••••" 
                {...register("password")}
                className={`mt-1 block w-full px-4 py-2.5 bg-zinc-50 dark:bg-zinc-800 border ${errors.password ? 'border-red-500' : 'border-zinc-300 dark:border-zinc-700'} rounded-xl text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-indigo-600 transition-all outline-none`} 
              />
            ...
            <div>
              ...
              <input 
                ...
                className={`mt-1 block w-full px-4 py-2.5 bg-zinc-50 dark:bg-zinc-800 border ${errors.confirmPassword ? 'border-red-500' : 'border-zinc-300 dark:border-zinc-700'} rounded-xl text-zinc-900 dark:text-zinc-100 focus:ring-2 focus:ring-indigo-600 transition-all outline-none`} 
              />
