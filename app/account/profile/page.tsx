...
async function getUserData() {
  // In a real app, you would use: const session = await getServerSession() or a database call
  return {
    name: "John Doe",
    email: "john.doe@example.com",
    joined: "January 2024",
    plan: "Pro Plan",
    bio: "Product Designer based in New York. I love building clean, user-centric interfaces.",
