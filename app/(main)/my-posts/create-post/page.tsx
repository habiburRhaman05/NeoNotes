    ...
    <div className={`min-h-screen p-6 transition-colors duration-300 ${isDark ? "bg-zinc-950 text-zinc-100" : "bg-zinc-50 text-zinc-900"}`}>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-6 bg-white dark:bg-zinc-900/50 p-8 rounded-[2rem] border border-zinc-200 dark:border-zinc-800 shadow-sm">
          ...
          {/* Editor Area */}
          <div className="space-y-2">
            <label className="text-sm font-bold text-zinc-500 uppercase tracking-widest">Content</label>
            <textarea
              value={content}
              onChange={(e) => setContent(e.target.value)}
              placeholder="The world is waiting for your story..."
              className="w-full h-80 rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-transparent px-5 py-4 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition resize-none leading-relaxed text-lg"
            />
          </div>
        </div>
      </div>
